...
public class NsdHelper {
    ...
    public static String mServiceName = "myNodeMCU";
    ...
    private static String ipadress ="/tryAgain";
    ...
    public void initializeResolveListener() {
        mResolveListener = new NsdManager.ResolveListener() {
            ...
            public void onServiceResolved(NsdServiceInfo serviceInfo) {
                ...
                setIpadress(serviceInfo.getHost().toString());
                setPot(serviceInfo.getPort());
                Log.e(TAG, "Resolve Succeeded. " + getPot());
